...
static const string mainnet_seeds[] = {"seeds.fixedtradecoin.org", ""};
static const string testnet_seeds[] = {"testnet-seeds.fixedtradecoin.org",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    // FXTC TODO: db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9468), true);
  }
  do {
